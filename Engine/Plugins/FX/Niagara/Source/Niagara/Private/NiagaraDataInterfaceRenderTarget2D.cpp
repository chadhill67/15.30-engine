...
public:
	...
	void Set(FRHICommandList& RHICmdList, const FNiagaraDataInterfaceSetArgs& Context) const
	{
		...
		if (OutputParam.IsUAVBound())
		{
			...
			if (Context.IsOutputStage && ProxyData->UAV.IsValid())
			{
				...
				RHICmdList.TransitionResource(EResourceTransitionAccess::EWritable, ProxyData->TextureReferenceRHI);
	...
	void Unset(FRHICommandList& RHICmdList, const FNiagaraDataInterfaceSetArgs& Context) const 
	{
		if (OutputParam.IsBound())
		{
			...
			if (ProxyData)
			{
				RHICmdList.TransitionResource(EResourceTransitionAccess::EReadable, ProxyData->TextureReferenceRHI);
