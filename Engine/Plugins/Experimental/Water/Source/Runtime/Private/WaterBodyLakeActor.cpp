...
#if WITH_EDITOR
	ActorIcon = FWaterIconHelper::EnsureSpriteComponentCreated(this, TEXT("/Water/Icons/WaterBodyLakeSprite"), NSLOCTEXT("Water", "WaterBodyLakeSpriteName", "Water Body Lake"));
#endif
...
void ULakeGenerator::OnUpdateBody(bool bWithExclusionVolumes)
{
	...
	if (!LakeMeshComp)
	{
		LakeMeshComp = NewObject<UStaticMeshComponent>(OwnerBody, TEXT("StaticMeshComponent"));
