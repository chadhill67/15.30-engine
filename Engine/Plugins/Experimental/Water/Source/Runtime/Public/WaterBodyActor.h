...
public:
	...
	virtual bool ShouldGenerateWaterMeshTile() const;
	...
	*/
	...
	//present in fortnite, overhauled in epic water code
	UPROPERTY(Category = FortniteProperty, EditAnywhere, BlueprintReadWrite)
	float MaxWaveHeight;

	//present in fortnite, overhauled in epic water code
	UPROPERTY(Category = FortniteProperty, EditAnywhere, BlueprintReadWrite, meta = (DisplayName = "River to Lake Transition"))
	UMaterialInterface* RiverToLakeTransitionMat;

	//present in fortnite, overhauled in epic water code
	UPROPERTY(Category = FortniteProperty, EditAnywhere, BlueprintReadWrite, meta = (DisplayName = "River to Ocean Transition"))
	...
	//present in fortnite, overhauled in epic water code
	UPROPERTY(Category = FortniteProperty, EditAnywhere, BlueprintReadWrite, Transient)
	float                                          OceanHeightOffset = 0.0f;

	//present in fortnite, overhauled in epic water code
	UFUNCTION(BlueprintCallable, Category=FortniteProperty)
...
protected:
	...
	//this was redone a lot, will probably need to edit a lot of stuff for proper wave preview in editor
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = Wave)
	virtual float GetMaxWaveHeight() const;
