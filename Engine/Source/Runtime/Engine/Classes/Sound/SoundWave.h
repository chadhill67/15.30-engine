...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Format|Quality", meta=(DisplayName = "Compression", ClampMin = "1", ClampMax = "100"), AssetRegistrySearchable)
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Playback|Streaming", meta = (DisplayName = "Force Streaming"))
	uint8 bStreaming:1;
